...
const galleryData = {
  '2026': [
    {
      id: "2026-cufest",
      title: "CUFest Event",
      subtitle: "2026 University Spring Festival",
    ...
    {
      id: "2026-yapim",
      title: "Build Process 2026",
      subtitle: "2026 Car Build Process",
  ...
  '2025': [
    ...
    {
      id: "2025-yapim",
      title: "Build Process 2025",
      subtitle: "2025 Car Build Process",
    ...
    },
    {
      ...
      subtitle: "Team New Year Celebration",
...
export default function GaleriEng() {
    ...
    <div className="galeri-page">
      ...
      <section className="galeri-hero reveal">
        <div className="container">
          ...
          <h1>Gallery</h1>
          <p className="hero-subtext">The most unforgettable moments, events, and workshop days of our team from past to present.</p>
        </div>
      </section>
