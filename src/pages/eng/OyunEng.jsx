...
export default function OyunEng() {
  return (
    <>
      {/* HERO */}
      <section className="page-hero oyun-hero">
        <div className="container">
          <p className="section-label reveal">// GAME</p>
          <div className="red-line reveal" />
          <h1 className="reveal reveal-delay-1">
            FEEL<br />THE <span className="text-red">TRACK</span>
          </h1>
          <p className="page-hero-sub reveal reveal-delay-2" style={{ maxWidth: '520px' }}>
            {/* EDIT: Oyun açıklamasını buraya ekle */}
            Experience the Formula Student world directly with the mobile game developed by the 1.5 Adana Formula Student team. Manage your own vehicle, race on the tracks, feel the passion.
          </p>
        </div>
      </section>
...
<section className="game-showcase">
  ...
  <div className="track-lines" />
        ...
        <span className="placeholder-tag">// TRACK IS PREPARING</span>
        <h3 className="placeholder-title">COMING SOON</h3>
        <p className="placeholder-desc">1.5 Adana Mobile Game is Loading...</p>
      </div>
      ...
      <section className="store-section">
        <div className="container">
          ...
          <div className="store-buttons reveal reveal-delay-1">
            ...
            <a href="#" className="store-btn card" aria-label="Download from App Store">
