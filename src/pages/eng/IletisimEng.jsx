...
export default function IletisimEng() {
  return (
    <>
      {/* HERO */}
      <section className="page-hero iletisim-hero">
        <div className="container">
          ...
          <h1 className="reveal reveal-delay-1">
            CONTACT<br /><span className="text-red">US</span>
          </h1>
          <p className="page-hero-sub reveal reveal-delay-2">
            You can reach out to us for sponsorship, collaboration, or any questions you may have.
          </p>
        </div>
      </section>
      ...
      <section className="social-section">
        <div className="container">
          <p className="section-label reveal">// SOCIAL MEDIA</p>
          <div className="red-line reveal" />
        ...
        <div className="container">
          ...
          <div className="map-address reveal reveal-delay-1">
            ...
            <p className="text-secondary mt-8" style={{ fontSize: '16px' }}>
              Çukurova University Tömer Building
            </p>
