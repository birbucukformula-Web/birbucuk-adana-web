    ...
    <div style={{ paddingTop: '80px' }}>
      <section className="season-section">
        <div className="container">
          ...
          {/* SEZON ARACI YAKINDA GELECEK / BİRLEŞEN ARABA PLACEHOLDER */}
<div className="season-main-img is-assembly-placeholder reveal reveal-delay-1">
  <div className="assembly-container">
    
    {/* SALDAN, SAĞDAN VE AŞAĞIDAN GELİP BİRLEŞEN FORMULA ARACI */}
    <div className="assembly-car-wrapper">
      <svg viewBox="0 0 100 40" fill="currentColor" className="f1-assembly-svg">
        
        {/* PARÇA 1: SOL DAN GELEN ARKA KANAT */}
        <g className="part-back">
          <path d="M 4 8 L 18 8 L 15 22 L 4 22 Z" />
          <path d="M 2 8 L 18 8" stroke="currentColor" strokeWidth="2" />
        </g>

        {/* PARÇA 2: YUKARIDAN GELEN ŞASİ VE KOKPİT */}
        <g className="part-body">
          <path d="M 16 22 L 38 17 C 42 12, 52 12, 56 17 L 72 20 L 76 29 L 58 28 L 22 28 Z" />
          <path d="M 46 17 C 48 14, 54 14, 57 17 Z" fill="#0d0d0d" />
          <circle cx="49" cy="15.5" r="1.8" />
        </g>

        {/* PARÇA 3: SAĞDAN GELEN ÖN BURUN VE ÖN KANAT */}
        <g className="part-front">
          <path d="M 72 20 L 92 26 L 98 28 L 98 30 L 88 30 L 76 29 Z" />
          <path d="M 88 30 L 98 30 L 96 25 L 88 28 Z" />
          <path d="M 88 31 L 100 31" stroke="currentColor" strokeWidth="1.5" />
        </g>

        {/* PARÇA 4: AŞAĞIDAN GELEN TEKERLEKLER */}
